...
export const sendSms = async (
  ...
  return customFetch<SmsResult>(getSendSmsUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export type SendSmsMutationError = ErrorType<ApiError>;
...
export type CreatePaymentIntentMutationError = ErrorType<ApiError>;
...
export const stripeWebhook = async (
  ...
  return customFetch<WebhookResult>(getStripeWebhookUrl(), {
    ...options,
    method: "POST",
  });
};
