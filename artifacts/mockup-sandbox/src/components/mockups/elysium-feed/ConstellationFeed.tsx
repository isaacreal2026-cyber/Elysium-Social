...
const NODES: NodeData[] = [
  {
    id: "center",
    author: "@aurelia",
    content: "The alignment is undeniable now.",
    energy: 95,
    kind: "Destiny",
    x: 50,
    y: 50,
  ...
  },
  {
    id: "n5",
    author: "@mirra",
    content: "Why does this feel like memory?",
    energy: 72,
    kind: "Question",
    x: 15,
    y: 65,
  },
  {
    id: "n6",
    author: "@stellarwave",
    content: "Present. Grounded. Alive.",
    energy: 55,
    kind: "Note",
    x: 35,
    y: 70,
    ...
    <div className="relative w-full h-[100dvh] bg-[#080815] constellation-starfield overflow-hidden text-slate-200 font-sans">
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  height: size,
                  background:
                    "radial-gradient(circle at center, #a855f7 0%, #1e1b4b 70%, #000000 100%)",
                  boxShadow: isActive
              ...
              <AnimatePresence>
                {isActive && (
                  <motion.div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(30, 27, 75, 0.9) 0%, rgba(8, 8, 21, 0.95) 100%)",
                      boxShadow:
                        "0 20px 40px rgba(0,0,0,0.5), 0 0 0 1px rgba(168, 85, 247, 0.2) inset",
                    }}
                  >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-4 pointer-events-none opacity-50 text-xs tracking-widest text-purple-200">
        <div className="flex items-center gap-2">
          <Disc size={14} className="animate-spin-slow" /> SCANNING
        </div>
      </div>
    </div>
  );
