    ...
    <ScreenShell title="Discover" subtitle="destinies, voices, hubs">
      ...
      >
        <SectionLabel
          ...
          caption="tap to enter a 15-second world"
        />
        <FlatList
          data={stories}
          horizontal
            ...
            return (
              ...
              >
                ...
                <View style={styles.storyTop}>
                  ...
                  <View
                    style={[styles.liveDot, { backgroundColor: colors.gold }]}
                  />
                </View>
                <View style={styles.storyBottom}>
                  <Text style={styles.storyCap} numberOfLines={2}>
                    {item.caption}
                  </Text>
                  <View
                    style={{
                  ...
                  >
                    {item.destinations.map((d) => (
                      <Text
                        key={d}
                        style={[styles.storyDest, { color: colors.gold }]}
                      >
                        #{d}
                      </Text>
                    ))}
        ...
        <SectionLabel
          title="Random Voice Party"
          caption="enter a small interest-matched room — leave anytime"
        />
        <View style={{ paddingHorizontal: 16, gap: 10 }}>
          ...
          >
            ...
            />
            <View style={{ flex: 1 }}>
              <Text style={[styles.partyTitle, { color: colors.text }]}>
                find a voice room
              </Text>
              <Text
                style={[styles.partyMeta, { color: colors.mutedForeground }]}
              >
                4–8 people · interest matched · gentle exit
              </Text>
            </View>
            <View
              style={[styles.partyAction, { backgroundColor: colors.primary }]}
            >
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <Text
                      style={[styles.roomTopic, { color: colors.text }]}
                      numberOfLines={1}
                    >
                      {vr.topic}
                    </Text>
                  ...
                  <Text
                    style={[styles.roomMeta, { color: colors.mutedForeground }]}
                  >
                    hosted by {host?.name} · {vr.vibe} · {vr.listeners}{" "}
                    listening
                  </Text>
                </View>
                <Feather
        ...
        <SectionLabel
          title="Trending Hubs"
          caption="where conversations are humming right now"
        />
        <View style={{ paddingHorizontal: 16, gap: 10 }}>
          {hubs.slice(0, 3).map((h) => (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[styles.hubLine, { color: colors.mutedForeground }]}
                  numberOfLines={1}
                >
                  {h.tagline}
                </Text>
                <View style={styles.hubStats}>
                  <Text style={[styles.hubStat, { color: colors.teal }]}>
                    {(h.members / 1000).toFixed(1)}k members
                  </Text>
                  <Text style={[styles.hubStat, { color: colors.gold }]}>
                    pulse {Math.round(h.pulse * 100)}
                  </Text>
                  <Text style={[styles.hubStat, { color: colors.magenta }]}>
                    {h.online.length} orbiting
                  </Text>
                </View>
              </View>
            </Pressable>
