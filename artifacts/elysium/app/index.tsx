...
export default function HomeFeed() {
  ...
  const sortedPosts = useMemo(() => {
    ...
    if (filter === "voice")
      return list
        .filter((p) => p.kind === "voice" || p.kind === "question")
        .sort((a, b) => b.energy - a.energy);
    if (filter === "destiny")
      return list
        .filter((p) => p.kind === "destiny" || p.kind === "media")
        .sort((a, b) => b.energy - a.energy);
    if (filter === "near")
              ...
              <View style={styles.iconsRow}>
                ...
                >
                  ...
                  {unreadNotifications > 0 ? (
                    <NotifDot n={unreadNotifications} />
                  ) : null}
                </Pressable>
              </View>
            </View>
              ...
              <Pressable
                ...
                style={[
                  styles.liveBanner,
                  {
                    ...
                    backgroundColor: colors.rose + "0C",
                  },
                ]}
              >
                <View
                  style={[styles.livePulse, { backgroundColor: colors.rose }]}
                />
                <Text style={[styles.liveLabel, { color: colors.rose }]}>
                  LIVE
                </Text>
                <Text
                  style={[styles.liveText, { color: colors.text }]}
                  numberOfLines={1}
                >
                  {liveRoom.topic}
                </Text>
                ...
                >
                  ...
                  <Text style={[styles.liveCountText, { color: colors.rose }]}>
                    {liveRoom.listeners}
                  </Text>
                </View>
