...
const TIERS = [
  {
    label: "Spark",
    amount: 299,
    desc: "Boost your resonance for 7 days",
    icon: "zap" as const,
    color: "#FFD56B",
  },
  {
    label: "Flame",
    amount: 799,
    desc: "Cosmic Pro — 1 month of full power",
    icon: "star" as const,
    color: "#F472B6",
  },
  {
    label: "Supernova",
    amount: 1999,
    desc: "Lifetime orbital prestige badge",
    icon: "award" as const,
    color: "#B57BFF",
  },
];
...
export default function PaymentScreen() {
      ...
      <ScreenShell title="Payment" showTabBar={false}>
        <View style={styles.successContainer}>
          ...
          <View
            style={[
              styles.successIcon,
              { borderColor: "#B57BFF55", backgroundColor: "#B57BFF22" },
            ]}
          >
          ...
          >
            Your {tier.label} upgrade is being processed. You'll receive a
  ...
  return (
    <ScreenShell
      title="Upgrade"
      subtitle="unlock your cosmic potential"
      showTabBar={false}
    >
      <ScrollView
      ...
      >
        ...
        {TIERS.map((t, i) => {
          ...
          return (
            ...
            >
              <View
                style={[styles.tierIcon, { backgroundColor: t.color + "22" }]}
              >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[styles.tierDesc, { color: colors.mutedForeground }]}
                >
                  {t.desc}
                </Text>
              </View>
              <View style={{ alignItems: "flex-end" }}>
                ...
                {active && (
                  <View
                    style={[styles.selectedDot, { backgroundColor: t.color }]}
                  />
                )}
              </View>
            </Pressable>
        ...
        <Text style={[styles.disclaimer, { color: colors.subtle }]}>
          Payments are processed securely via Stripe. Connect Stripe credentials
          in Secrets to activate.
        </Text>
      </ScrollView>
    </ScreenShell>
  );
