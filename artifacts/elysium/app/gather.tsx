      ...
      >
        {section === "paths"
          ? paths.map((p) => (
              ...
              >
                <View
                  style={[styles.tone, { backgroundColor: TONES[p.toneIndex] }]}
                />
                <View style={{ flex: 1 }}>
                  ...
                  >
                    by {p.curator} · {p.modules} modules · {p.category}
                  </Text>
                  <View
                    style={[
                    ...
                    <View
                      style={[
                        styles.progressFill,
                        {
                          ...
                          backgroundColor: TONES[p.toneIndex],
                        },
                      ]}
                    />
                  </View>
...
const LIBRARY = [
  {
    title: "On the Architecture of Attention",
    summary:
      "How tools shape the rhythm of our days — and what to do about it.",
    minutes: 14,
    discussions: 312,
  },
  {
    title: "Quiet, A Founder's Manual",
    summary:
      "A short field guide to building hard things without losing yourself.",
    minutes: 9,
    discussions: 142,
  },
  {
    title: "Listening Cities",
    summary: "What we hear when we stop performing.",
    minutes: 11,
    discussions: 78,
  },
  {
    title: "Your Network is a Forest",
    summary: "Why density is more important than reach.",
    minutes: 7,
    discussions: 244,
  },
];
...
const VIDEOS = [
  {
    title: "How Aria scores empty rooms",
    creator: "Aria Volkov",
    duration: "12:04",
    live: false,
    viewers: 1402,
  ...
  {
    title: "Slow software, live build",
    creator: "Kenji Park",
    duration: "ongoing",
    live: true,
    viewers: 318,
